namespace OperationManager
{
    public static class UITexts
    {
        ...
        public const string _operationSelectRequest = "Please choose an operation to perform.";
        public const string _numberInputRequest = "Please input two numbers seperated by comma(',') or space.";
